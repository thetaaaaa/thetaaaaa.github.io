...
硕士期间我长期做计算人文方向的研究：一边开发和评测基于机器学习、神经网络模型的古文自动化处理工具，一边做中国古代文献的知识组织与知识挖掘。也因此我对流程的规范性大概有点执拗——开头省下的那点时间，后面会以十倍要回去。这件事单独写了一篇：[为什么要建这个站点]({{ '/2026/why-this-site/' | relative_url }})。
...
My master's work was in computational humanities — what is more often called digital humanities: developing and evaluating machine-learning and neural-network tools for the automated processing of classical Chinese, and working on knowledge organization and knowledge mining over premodern Chinese sources. It left me with a stubbornness about the discipline of a workflow: whatever time you save at the beginning, you pay back tenfold later. I've written that out separately — [why this site exists]({{ '/2026/why-this-site/' | relative_url }}).
